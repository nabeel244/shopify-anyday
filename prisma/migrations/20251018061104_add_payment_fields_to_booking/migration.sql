...
INSERT INTO "new_bookings" ("bookingDate", "createdAt", "endTime", "id", "productBookingConfigId", "selectedServices", "serviceId", "specialRequests", "startTime", "status", "totalPrice", "updatedAt", "userId") SELECT "bookingDate", "createdAt", "endTime", "id", "productBookingConfigId", "selectedServices", "serviceId", "specialRequests", "startTime", "status", "totalPrice", "updatedAt", "userId" FROM "bookings";
DROP TABLE "bookings";
